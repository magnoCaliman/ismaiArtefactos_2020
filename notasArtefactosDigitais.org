...
- ~int x = 10~ -> Dissecando as 4 partes do uso de uma variável:
...
- Ex.9 - Tone sequenciador com variável -  https://www.tinkercad.com/things/jIMzNe9eevD 
  - Código é para o computador rodar, e para o progamador ler!
#+BEGIN_SRC c
void setup()
{
  pinMode(5, OUTPUT);
...
- TPC: resolver o experimento 2 & criar algum circuito usando random() e variáveis
