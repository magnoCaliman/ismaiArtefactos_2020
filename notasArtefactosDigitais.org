...
- Como fazer para ver esse valor?
...
- Testa uma condição /booleana/ e /condiciona/ a execução de um bloco de código à esse teste.
...
*** Desafio extra:
- Crie um circuito onde ao apertar um botão um LED acenda /e permaneça acesso/, e ao apertar de novo, o LED apague.
