...
- Experimento 5:
  - Construa um circuito onde um potenciometro controla o tempo de piscagem de um LED.
...
- Documentação: https://www.arduino.cc/reference/en/language/functions/math/map/
  - Como reescrever os números em uma régua...
...
- ~map()~ escalona proporcionalmente um /âmbito de entrada/ para um /âmbito de saída/. É uma função que faz regra de três... 
...
- Experimento 6: construa o seguinte circuito, de modo que o valor máximo de rotação do motor seja aproximadamente 1000 RPM.
  - Possível solução: https://www.tinkercad.com/things/3bkbxhNegGF 

** LDR
** transistor + potenciômetro
